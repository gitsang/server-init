...
PROMPT="%B${NEWLINE}${PROMPT_HOSTNAME} ${PROMPT_DATE} ${PROMPT_WORKDIR} ${PROMPT_GITBRANCH}%b ${PROMPT_CMDLINE}"

PROMPT_ENV_ANSIBLE_DEPLOY_ENV='[ANSIBLE_DEPLOY_ENV: ${ANSIBLE_DEPLOY_ENV}]'
PROMPT_ENV_HTTP_PROXY='[http_proxy: ${http_proxy}]'
PROMPT_ENV="%F{245}${PROMPT_ENV_ANSIBLE_DEPLOY_ENV} ${PROMPT_ENV_HTTP_PROXY}%f"
